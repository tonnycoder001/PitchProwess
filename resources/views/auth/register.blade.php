...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="container mx-auto max-w-sm px-4 py-8 bg-white shadow-lg rounded-lg">
        ...
        <form action="" method="post" class="space-y-4">
            ...
            <div class="flex flex-col">
                ...
                <input type="text" id="name" name="name"
                    class="px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 @error('name') border-red-500 @enderror"
            ...
            <div class="flex flex-col">
                ...
                <input type="email" id="email" name="email"
                    class="px-3 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 @error('email') border-red-500 @enderror"
